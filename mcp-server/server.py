...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "   Step 5: start_screening (Only if eligible)\n"
        "   Step 6: get_next_question -> submit_answer (loop until done)\n"
        "   Step 7: submit_application\n"
        "   Step 8: get_application_status\n"
        "   NEVER skip a step. NEVER change the order. If you try to skip, the server will reject it.\n"
        "4. For the screening prompt question, the candidate must write their OWN prompt. "
